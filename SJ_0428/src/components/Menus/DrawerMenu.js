        ...
        store => (
          <StDrawerMenuCont id="drawer-container">
            ...
            {store.curMode === 'adjust' &&
              // <Adjust/>
              <>
              <input id="blur" type="range" min="0" max="50" step="10"
              value={store.blur}
              ...
              <input id="lum" type="range" min="-1" max="1" step="0.1"
              value={store.lum}
              onChange={store.changeAdjust}/>
              </>
            }
              ...
              <div>
                ...
                {store.tagList.map((tag, i) => {
                  ...
                  <Button size="small" variant="contained" color="primary" 
                    style={{borderRadius:"12px", marginLeft:"4px", marginBottom:"3px"}}
                    onClick={(e) => this.clickTag({i}, originalTagList, customTagList, e)} key={i}>
                    {tag}
                  </Button>);
                })}
                <br/>
                <Button variant="contained" color="primary" href="#contained-buttons" 
                  ...
                  onClick={() =>this.clickCopy(customTagList, originalTagList)}>
                  Copy
                </Button>
              </div>
            }
